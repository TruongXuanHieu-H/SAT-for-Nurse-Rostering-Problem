#ifndef NRP_ENCODER_ADDER_H
#define NRP_ENCODER_ADDER_H

#include "nrp_encoder.h"

class NRPEncoderAdder : public NRPEncoder
{
    public:
        NRPEncoderAdder(SATSolver *sat_solver, VarHandler *var_handler);
        ~NRPEncoderAdder();
